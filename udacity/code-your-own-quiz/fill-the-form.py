...
data = {
    'easy': {
        'phrase': '''Hello ___1___!'  In ___2___ this is particularly easy; all you have to do is type in: ___3____ "Hello ___1___!"
...
def check_replacement(string, user_input):
    for word in string:
        replacement = find_word(word, data['to_be_changed'])
